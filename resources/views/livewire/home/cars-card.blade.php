<div class="grid grid-cols-1 md:grid-cols-3 gap-6 bg-gray-100 p-6">
    <div class="bg-white rounded-lg shadow-md p-6 text-center">
        ...
        <a href="/auto-model/skoda-octavia/" class="bg-red-500 text-white py-2 px-4 rounded-lg">FOGLALÁS</a>
    </div>
    <div class="bg-white rounded-lg shadow-md p-6 text-center">
        ...
        <a href="/auto-model/skoda-rs/" class="bg-red-500 text-white py-2 px-4 rounded-lg">FOGLALÁS</a>
    </div>
    <div class="bg-white rounded-lg shadow-md p-6 text-center">
        ...
        <a href="/auto-model/skoda-superb/" class="bg-red-500 text-white py-2 px-4 rounded-lg">FOGLALÁS</a>
    </div>
</div>
